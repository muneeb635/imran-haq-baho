var P = "top",
    ...
    Cn = [].concat(Bt, [$e]).reduce(function (e, t) {
...
function Oi(e) {
    ...
    var r = Ie(e);
    for (Nn(r) && (r = r.host); B(r) && ["html", "body"].indexOf(Q(r)) < 0; ) {
        var i = st(r);
        if (
            i.transform !== "none" ||
            i.perspective !== "none" ||
...
function ee(e) {
    for (var t = F(e), n = is(e); n && wi(n) && st(n).position === "static"; )
        n = is(n);
    return n &&
...
function os(e) {
    var t,
        ...
        p = o.y,
        m = p === void 0 ? 0 : p,
        b = typeof l == "function" ? l({ x: _, y: m }) : { x: _, y: m };
    (_ = b.x), (m = b.y);
    ...
    var $ = Object.assign({ position: a }, c && Li),
        Y = l === !0 ? Ri({ x: _, y: m }, F(n)) : { x: _, y: m };
    if (((_ = Y.x), (m = Y.y), u)) {
        var I;
...
var Pi = { left: "right", right: "left", bottom: "top", top: "bottom" };
function ve(e) {
...
function xn(e) {
    return xt(ft(e)).left + Pn(e).scrollLeft;
}
function Mi(e, t) {
    var n = F(e),
        s = ft(e),
...
function cs(e, t, n) {
    return t === Sn ? gn(Mi(e, n)) : Tt(t) ? Vi(t, n) : gn(ki(ft(e)));
}
function Hi(e) {
    var t = Qt(Ie(e)),
...
function Fi(e, t, n, s) {
    var r = t === "clippingParents" ? Hi(e) : [].concat(t),
        i = [].concat(r, [n]),
        o = i[0],
...
function kt(e, t) {
    ...
    var n = t,
        ...
        S = e.rects.popper,
        v = e.elements[p ? T : g],
        w = Fi(Tt(v) ? v : v.contextElement || ft(e.elements.popper), u, l, o),
...
function Bi(e, t) {
    ...
    return Object.keys(_).sort(function (p, m) {
        return _[p] - _[m];
    });
}
function ji(e) {
...
function Wi(e) {
    ...
    if (!t.modifiersData[s]._skip) {
        for (
            ...
            if (
                (i && _t.push(k[Y] <= 0),
                a && _t.push(k[z] <= 0, k[ce] <= 0),
                _t.every(function (St) {
                    return St;
                }))
            ) {
                (L = $), (R = !1);
                ...
                var le = p ? 3 : 1,
                    Ke = function (it) {
                        var zt = v.find(function (fe) {
                            var gt = C.get(fe);
                            if (gt)
                                return gt.slice(0, it).every(function (Ye) {
                                    return Ye;
                                });
                        });
    ...
    if (O) {
        if (i) {
            var I,
                ...
                Yt = T === At ? -R[k] : -C[k],
                ue = t.elements.arrow,
                St = _ && ue ? Ln(ue) : { width: 0, height: 0 },
                ...
                gt = Jt(0, C[k], St[k]),
                Ye = S
                    ? C[k] / 2 - le - gt - zt - D.mainAxis
                    : Ke - gt - zt - D.mainAxis,
                _i = S
                    ? -C[k] / 2 + le + gt + fe + D.mainAxis
                    : Yt + gt + fe + D.mainAxis,
                ze = t.elements.arrow && ee(t.elements.arrow),
                gi = ze
                    ? v === "y"
                        ? ze.clientTop || 0
                        : ze.clientLeft || 0
                ...
                Ei = z + Ye - Xn - gi,
                bi = z + _i - Xn,
                Jn = Jt(_ ? Ce(ce, Ei) : ce, z, _ ? yt(_t, bi) : _t);
            (O[v] = Jn), (Y[v] = Jn - z);
        }
        if (a) {
            var Qn,
                ...
                ns = qe ? Zn : Et - C[de] - R[de] - es + D.altAxis,
                ss = qe ? Et + C[de] + R[de] - es - D.altAxis : ts,
                rs =
                    _ && qe ? Si(ns, Et, ss) : Jt(_ ? ns : Zn, Et, _ ? ss : ts);
            (O[w] = rs), (Y[w] = rs - Et);
        }
        t.modifiersData[s] = Y;
    }
...
function Pe(e) {
    ...
    return function (a, u, c) {
        ...
        var l = {
            ...
            _ = {
                ...
                setOptions: function (y) {
                    ...
                    var S = eo(so([].concat(s, l.options.modifiers)));
                    return (
        ...
        if (!ds(a, u)) return _;
        _.setOptions(c).then(function (b) {
        ...
        function p() {
            l.orderedModifiers.forEach(function (b) {
                ...
                if (typeof v == "function") {
                    var w = v({ state: l, name: y, instance: _, options: S }),
                        O = function () {};
                    h.push(w || O);
                }
            });
...
var ro = Pe(),
    io = [In, kn, $n, Dn],
    oo = Pe({ defaultModifiers: io }),
    ao = [In, kn, $n, Dn, br, gr, vr, pr, Er],
    Vn = Pe({ defaultModifiers: ao });
 ...
 */ const ot = new Map(),
    ...
    uo = (e) =>
        e == null
            ...
            : Object.prototype.toString
                  ...
                  .toLowerCase(),
    fo = (e) => {
        do e += Math.floor(Math.random() * co);
    ...
    ho = (e) => {
        ...
        return !s && !r
            ...
            : ((t = t.split(",")[0]),
              (n = n.split(",")[0]),
              (Number.parseFloat(t) + Number.parseFloat(n)) * lo);
    },
    Tr = (e) => {
...
const d = {
    ...
    off(e, t, n, s) {
        ...
        if (l) for (const h of Object.keys(u)) yo(e, u, h, t.slice(1));
        for (const [h, g] of Object.entries(c)) {
            const _ = h.replace(go, "");
            (!a || t.includes(_)) &&
                bn(e, u, o, g.callable, g.delegationSelector);
        }
    },
    trigger(e, t, n) {
...
const et = {
    ...
    getDataAttribute(e, t) {
        return ms(e.getAttribute(`data-bs-${Qe(t)}`));
    },
};
class se {
    static get Default() {
...
class G extends se {
    ...
    static getInstance(t) {
        return Ge.get(ct(t), this.DATA_KEY);
    }
...
class Me extends G {
    ...
    close() {
        if (d.trigger(this._element, Oo).defaultPrevented) return;
        this._element.classList.remove(No);
        const n = this._element.classList.contains(Co);
        this._queueCallback(() => this._destroyElement(), this._element, n);
    }
    _destroyElement() {
        this._element.remove(), d.trigger(this._element, So), this.dispose();
    }
...
class ke extends G {
    ...
    toggle() {
        this._element.setAttribute(
            "aria-pressed",
            this._element.classList.toggle(Io)
        );
    }
    static jQueryInterface(t) {
        return this.each(function () {
...
const xo = "swipe",
    ...
    Wo = "pointer-event",
    Uo = 40,
    Ko = { endCallback: null, leftCallback: null, rightCallback: null },
    Yo = {
...
class De extends se {
    ...
    _initEvents() {
        this._supportPointerEvents
            ? (d.on(this._element, Ho, (t) => this._start(t)),
              d.on(this._element, Fo, (t) => this._end(t)),
              this._element.classList.add(Wo))
            : (d.on(this._element, Mo, (t) => this._start(t)),
              d.on(this._element, ko, (t) => this._move(t)),
              d.on(this._element, Vo, (t) => this._end(t)));
    }
    _eventIsPointerPenTouch(t) {
        return (
            this._supportPointerEvents &&
            (t.pointerType === jo || t.pointerType === Bo)
        );
    }
    static isSupported() {
        return (
...
const zo = "carousel",
    ...
    pe = "active",
    ia = "slide",
    oa = "carousel-item-end",
    aa = "carousel-item-start",
    ca = "carousel-item-next",
    la = "carousel-item-prev",
    Mr = ".active",
    kr = ".carousel-item",
    ua = Mr + kr,
    fa = ".carousel-item img",
    da = ".carousel-indicators",
    ha = "[data-bs-slide], [data-bs-slide-to]",
    pa = '[data-bs-ride="carousel"]',
    ma = { [Go]: ye, [Xo]: Lt },
    _a = {
        interval: 5e3,
        keyboard: !0,
...
class re extends G {
    constructor(t, n) {
        super(t, n),
            ...
            (this._indicatorsElement = E.findOne(da, this._element)),
    ...
    _addEventListeners() {
        this._config.keyboard &&
            d.on(this._element, Zo, (t) => this._keydown(t)),
            this._config.pause === "hover" &&
                (d.on(this._element, ta, () => this.pause()),
                d.on(this._element, ea, () => this._maybeEnableCycle())),
            this._config.touch &&
                De.isSupported() &&
                this._addTouchEventListeners();
    }
    _addTouchEventListeners() {
        for (const s of E.find(fa, this._element))
            d.on(s, na, (r) => r.preventDefault());
        const n = {
    ...
    _isAnimated() {
        return this._element.classList.contains(ia);
    }
    _getActive() {
        return E.findOne(ua, this._element);
    }
    _getItems() {
...
d.on(document, ra, ha, function (e) {
...
const Ea = "collapse",
    ...
    Sa = "collapsed",
    Ca = `:scope .${$t} .${$t}`,
    Na = "collapse-horizontal",
    Da = "width",
    La = "height",
    Ra = ".collapse.show, .collapse.collapsing",
    vn = '[data-bs-toggle="collapse"]',
    $a = { parent: null, toggle: !0 },
    Ia = { parent: "(null|element)", toggle: "boolean" };
class Zt extends G {
    constructor(t, n) {
    ...
    show() {
        ...
        if (
            (this._config.parent &&
                (t = this._getFirstLevelChildren(Ra)
                    .filter((a) => a !== this._element)
                    .map((a) => Zt.getOrCreateInstance(a, { toggle: !1 }))),
            (t.length && t[0]._isTransitioning) ||
                d.trigger(this._element, ya).defaultPrevented)
        )
            return;
        ...
        const r = () => {
                (this._isTransitioning = !1),
                    ...
                    this._element.classList.add($t, en),
                    (this._element.style[s] = ""),
                    d.trigger(this._element, Aa);
            },
    ...
    hide() {
        if (
            ...
            !this._isShown() ||
            d.trigger(this._element, Ta).defaultPrevented
        )
            return;
        ...
        (this._element.style[n] = `${
            ...
            ne(this._element),
            this._element.classList.add(me),
            this._element.classList.remove($t, en);
    ...
    _getDimension() {
        return this._element.classList.contains(Na) ? Da : La;
    }
    _initializeChildren() {
    ...
    _getFirstLevelChildren(t) {
        const n = E.find(Ca, this._config.parent);
        return E.find(t, this._config.parent).filter((s) => !n.includes(s));
    }
    _addAriaAndCollapsedClass(t, n) {
        if (t.length)
            for (const s of t)
                s.classList.toggle(Sa, !n), s.setAttribute("aria-expanded", n);
    }
    static jQueryInterface(t) {
        const n = {};
        return (
...
d.on(document, Oa, vn, function (e) {
    (e.target.tagName === "A" ||
...
const gs = "dropdown",
    ...
    Ga = ".navbar",
    Xa = ".navbar-nav",
    Ja = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",
    Qa = W() ? "top-end" : "top-start",
    Za = W() ? "top-start" : "top-end",
    tc = W() ? "bottom-end" : "bottom-start",
    ec = W() ? "bottom-start" : "bottom-end",
    nc = W() ? "left-start" : "right-start",
    sc = W() ? "right-start" : "left-start",
    rc = "top",
    ic = "bottom",
    oc = {
        autoClose: !0,
...
class J extends G {
    ...
    show() {
        ...
        if (!d.trigger(this._element, Fa, t).defaultPrevented) {
            if (
                (this._createPopper(),
                "ontouchstart" in document.documentElement &&
                    !this._parent.closest(Xa))
            )
    ...
    _completeHide(t) {
        if (!d.trigger(this._element, Va, t).defaultPrevented) {
    ...
    _getPlacement() {
        ...
        if (t.classList.contains(za)) return ic;
        const n =
            getComputedStyle(this._menu)
                .getPropertyValue("--bs-position")
                .trim() === "end";
        return t.classList.contains(Wa) ? (n ? Za : Qa) : n ? ec : tc;
    }
    _detectNavbar() {
    ...
    _selectMenuItem({ key: t, target: n }) {
        const s = E.find(Ja, this._menu).filter((r) => jt(r));
        s.length && Hn(s, n, t === bs, !s.includes(n)).focus();
    }
    static jQueryInterface(t) {
        return this.each(function () {
    ...
    static clearMenus(t) {
        if (t.button === ka || (t.type === "keyup" && t.key !== Es)) return;
        const n = E.find(qa);
        for (const s of n) {
    ...
    _getElement() {
        if (!this._element) {
            ...
            (t.className = this._config.className),
                this._config.isAnimated && t.classList.add(cc),
                (this._element = t);
        }
...
const fc = "focustrap",
    ...
    Ec = { autofocus: "boolean", trapElement: "element" };
class jr extends se {
    constructor(t) {
        super(),
            (this._config = this._getConfig(t)),
    ...
    activate() {
        this._isActive ||
            ...
            d.off(document, Le),
            d.on(document, hc, (t) => this._handleFocusin(t)),
            d.on(document, pc, (t) => this._handleKeydown(t)),
            (this._isActive = !0));
    }
    deactivate() {
    ...
    _handleKeydown(t) {
        t.key === mc && (this._lastTabNavDirection = t.shiftKey ? As : _c);
    }
}
...
class yn {
    ...
    hide() {
        ...
        this._disableOverFlow(),
            this._setElementAttributes(this._element, _e, (n) => n + t),
    ...
    reset() {
        this._resetElementAttributes(this._element, "overflow"),
            ...
            this._resetElementAttributes(Ts, _e),
...
const bc = "modal",
    ...
    Sc = `resize${U}`,
    Cc = `click.dismiss${U}`,
    Nc = `mousedown.dismiss${U}`,
    Dc = `keydown.dismiss${U}`,
    Lc = `click${U}${yc}`,
    Ss = "modal-open",
    Rc = "fade",
    Cs = "show",
    ...
    Ic = ".modal-dialog",
    Pc = ".modal-body",
    xc = '[data-bs-toggle="modal"]',
    Mc = { backdrop: !0, focus: !0, keyboard: !0 },
    kc = {
...
class Vt extends G {
    constructor(t, n) {
        super(t, n),
            (this._dialog = E.findOne(Ic, this._element)),
    ...
    hide() {
        !this._isShown ||
            this._isTransitioning ||
            d.trigger(this._element, Tc).defaultPrevented ||
            ((this._isShown = !1),
            (this._isTransitioning = !0),
    ...
    _showElement(t) {
        ...
        const n = E.findOne(Pc, this._dialog);
        n && (n.scrollTop = 0),
            ne(this._element),
        ...
        const s = () => {
            this._config.focus && this._focustrap.activate(),
                (this._isTransitioning = !1),
                d.trigger(this._element, Oc, { relatedTarget: t });
        };
        this._queueCallback(s, this._dialog, this._isAnimated());
    }
    _addEventListeners() {
        d.on(this._element, Dc, (t) => {
            if (t.key === Ac) {
    ...
    _triggerBackdropTransition() {
        if (d.trigger(this._element, wc).defaultPrevented) return;
        const n =
...
d.on(document, Lc, xc, function (e) {
    const t = E.getElementFromSelector(this);
...
const Vc = "offcanvas",
    ...
    Yc = `resize${rt}`,
    zc = `click${rt}${Kr}`,
    qc = `keydown.dismiss${rt}`,
    Gc = '[data-bs-toggle="offcanvas"]',
    Xc = { backdrop: !0, keyboard: !0, scroll: !1 },
    Jc = {
        backdrop: "(boolean|string)",
        keyboard: "boolean",
        scroll: "boolean",
...
class ut extends G {
    ...
    show(t) {
        if (
            this._isShown ||
            d.trigger(this._element, Wc, { relatedTarget: t }).defaultPrevented
        )
            return;
        (this._isShown = !0),
            this._backdrop.show(),
        ...
        const s = () => {
            (!this._config.scroll || this._config.backdrop) &&
                ...
                d.trigger(this._element, Uc, { relatedTarget: t });
        };
        this._queueCallback(s, this._element, !0);
    }
    hide() {
        if (!this._isShown || d.trigger(this._element, Kc).defaultPrevented)
            return;
        this._focustrap.deactivate(),
            this._element.blur(),
            (this._isShown = !1),
...
d.on(document, zc, Gc, function (e) {
    const t = E.getElementFromSelector(this);
...
class Ut extends G {
    ...
    _createTipElement(t) {
        ...
        if (!n) return null;
        n.classList.remove(sn, ge),
            n.classList.add(`bs-${this.constructor.NAME}-auto`);
        const s = fo(this.constructor.NAME).toString();
        return (
            n.setAttribute("id", s),
            this._isAnimated() && n.classList.add(sn),
            n
        );
    }
    setContent(t) {
        ...
        for (const n of t)
            if (n === "click")
                ...
                d.on(this._element, s, this._config.selector, (i) => {
                    ...
                    (o._activeTrigger[i.type === "focusin" ? rn : Gt] = !0),
                        o._enter();
                }),
                    d.on(this._element, r, this._config.selector, (i) => {
                        const o = this._initializeOnDelegatedTarget(i);
                        (o._activeTrigger[i.type === "focusout" ? rn : Gt] =
...
const Cl = "popover",
    ...
    Rl = { ...Ut.DefaultType, content: "(null|string|element|function)" };
class jn extends Ut {
    static get Default() {
        return Ll;
    }
...
class Ve extends G {
    ...
    _maybeEnableSmoothScroll() {
        this._config.smoothScroll &&
            ...
            d.on(this._config.target, Ps, on, (t) => {
    ...
    _activateParents(t) {
        if (t.classList.contains(kl)) {
            E.findOne(Ul, t.closest(Wl)).classList.add(Nt);
            return;
        }
        for (const n of E.parents(t, Hl))
            for (const s of E.prev(n, jl)) s.classList.add(Nt);
    }
    _clearActiveClass(t) {
        t.classList.remove(Nt);
        const n = E.find(`${on}.${Nt}`, t);
...
d.on(window, Ml, () => {
    for (const e of E.find(Vl)) Ve.getOrCreateInstance(e);
});
K(Ve);
const zl = "tab",
    ql = "bs.tab",
    ...
    lu = `.nav-link${ln}, .list-group-item${ln}, [role="tab"]${ln}`,
    Gr =
        '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',
    un = `${lu}, ${Gr}`,
    uu = `.${vt}[data-bs-toggle="tab"], .${vt}[data-bs-toggle="pill"], .${vt}[data-bs-toggle="list"]`;
class Ht extends G {
    constructor(t) {
        super(t),
    ...
    _keydown(t) {
        if (![nu, Ms, su, ks, an, Vs].includes(t.key)) return;
        t.stopPropagation(), t.preventDefault();
        const n = this._getChildren().filter((r) => !lt(r));
        let s;
        if ([an, Vs].includes(t.key)) s = n[t.key === an ? 0 : n.length - 1];
        else {
    ...
    _toggleDropDown(t, n) {
        ...
        r(iu, vt), r(ou, cn), s.setAttribute("aria-expanded", n);
    }
...
d.on(document, Zl, Gr, function (e) {
    ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
        !lt(this) && Ht.getOrCreateInstance(this).show();
});
d.on(window, eu, () => {
    for (const e of E.find(uu)) Ht.getOrCreateInstance(e);
});
K(Ht);
const fu = "toast",
    du = "bs.toast",
...
class He extends G {
    ...
    _setListeners() {
        d.on(this._element, hu, (t) => this._onInteraction(t, !0)),
            ...
            d.on(this._element, mu, (t) => this._onInteraction(t, !0)),
...
const ku = (e, t, n, { allOwnKeys: s } = {}) => (
    ...
    js = "0123456789",
    si = { DIGIT: js, ALPHA: fn, ALPHA_DIGIT: fn + fn.toUpperCase() + js },
...
const ef = (e) => {
    ...
    nf = Z("AsyncFunction"),
    sf = (e) => e && (je(e) || j(e)) && j(e.then) && j(e.catch),
    f = {
        isArray: Kt,
        isArrayBuffer: Jr,
        isBuffer: Ou,
...
const af = f.toFlatObject(f, {}, null, function (t) {
    ...
    function l(p, m, b) {
        ...
        if (p && !b && typeof p == "object") {
            if (f.endsWith(m, "{}"))
                ...
                (f.isArray(p) && of(p)) ||
                ((f.isFileList(p) || f.endsWith(m, "[]")) && (y = f.toArray(p)))
            )
                return (
                    (m = oi(m)),
        ...
        return Tn(p) ? !0 : (t.append(Ws(b, m, i), c(p)), !1);
    }
    const h = [],
        g = Object.assign(af, {
            defaultVisitor: l,
            ...
            h.push(p),
                f.forEach(p, function (y, T) {
                    (!(f.isUndefined(y) || y === null) &&
                        r.call(t, y, f.isString(T) ? T.trim() : T, m, g)) ===
                        !0 && _(y, m ? m.concat(T) : [T]);
                }),
                h.pop();
        }
    }
...
const Ks = lf,
    ...
    uf = typeof URLSearchParams < "u" ? URLSearchParams : Kn,
    ...
    q = {
        isBrowser: !0,
        classes: { URLSearchParams: uf, FormData: ff, Blob: df },
        ...
        return (
            ...
            u
                ...
                : ((!r[o] || !f.isObject(r[o])) && (r[o] = []),
                  t(n, s, r[o], i) && f.isArray(r[o]) && (r[o] = gf(r[o])),
                  !a)
        );
    }
...
f.reduceDescriptors(Ue.prototype, ({ value: e }, t) => {
...
const Sf = q.isStandardBrowserEnv
    ? (function () {
          return {
...
const Df = q.isStandardBrowserEnv
    ? (function () {
            ...
            return new Promise(function (n, s) {
                ...
                if (e.auth) {
                    const _ = e.auth.username || "",
                        p = e.auth.password
                            ...
                            : "";
                    i.set("Authorization", "Basic " + btoa(_ + ":" + p));
                }
                ...
                r === void 0 && i.setContentType(null),
                    "setRequestHeader" in c &&
                        f.forEach(i.toJSON(), function (p, m) {
...
function qs(e) {
    return (
        ...
        hi
            .getAdapter(e.adapter || zn.adapter)(e)
            .then(
                function (s) {
                    return (
                        pn(e),
...
const wn = { assertOptions: Pf, validators: qn },
    at = wn.validators;
class Re {
    constructor(t) {
        (this.defaults = t),
    ...
    request(t, n) {
        ...
        this.interceptors.request.forEach(function (m) {
            (typeof m.runWhen == "function" && m.runWhen(n) === !1) ||
                ((u = u && m.synchronous), a.unshift(m.fulfilled, m.rejected));
        });
        const c = [];
...
N.mergeConfig = Ft;
N.AxiosHeaders = nt;
N.formToJSON = (e) => ui(f.isHTMLForm(e) ? new FormData(e) : e);
N.getAdapter = hi.getAdapter;
N.HttpStatusCode = Vf;
N.default = N;
const Hf = N;
window.axios = Hf;
